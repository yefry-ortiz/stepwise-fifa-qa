...
questions:
  ...
  - question_id: "OQ-003"
    ...
    status: "RESOLVED"
    answer: "Basic element mapping would be beneficial. Document high-level element categories (navigation menus, content areas, links) without specific selectors to improve test design precision."